...
import { Mail, Lock, Feather, AlertCircle, RefreshCw, UserCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0b0f19] px-4">
      ...
      <div className="relative w-full max-w-md bg-[#131b2e] border border-slate-800 rounded-2xl p-8 shadow-2xl backdrop-blur-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-2">Log in to manage your EmpathWrite documents</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-slate-500">
          New to EmpathWrite?{' '}
          <Link to="/signup" className="text-[#059669] hover:text-[#047857] font-medium underline underline-offset-4">
            Create account
          </Link>
        </div>
      </div>
